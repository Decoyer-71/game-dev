...
| **4** | Unity UI 바인딩 (텍스트/도형만, 2~3화면) | **⚙ 진행 중 (2026-08-23)** — 브랜치 `ui/combat-view`. **✅ 첫 화면(무공 목록·상세) 완료 — Play 4차 사용자 확인.** 한글 · 런타임 조립(에디터 작업 **0**) · Core 바인딩 · 스크롤 · 필터 · 표가 전부 섰다. `dotnet test` **255/0/0** · 기준선 791건 동일. 경위 [`HANDOFF §4-16`](../../docs/HANDOFF.md) · 설계 [`ui-martial-list-plan.md`](../../docs/ui-martial-list-plan.md). ⏭ 다음 화면은 **사용자 결정** — 전투 화면이 유력하다(범위 대가 T 확정의 선행 조건) |

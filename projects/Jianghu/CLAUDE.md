...
| **2** | 무공·문파·상태이상 체계 | **⚠⚠ 진행 중 (2026-08-05)** — 개별 수치 → **한자 형태소 조합 자동 유도**로 전환 완료. 사전 **88자** + 배경어 6자 · 파서 · 조합 규칙 · **무공 138종 작명 완료** · 카탈로그 수치 0줄. **치명 · 상태이상 · 방어군 4축 · 피해 눈금 · 속도 · 유형 숙달 · 절대경지 규칙 4종 · 기력 축 전부 연결 완료.** dotnet **200/200**. ⚠⚠ **Unity 확인 두 세션째 밀림** — 마지막이 9차(199/199 · `Combat` 75 · `Martial` 115 · `Rng` 9)이고 그 뒤 Core 를 고쳤다. **다음 세션 첫 작업**(기대값 ✅200 · `Combat` 76). 남은 것은 **인계문서 §4-9-5**. 정의서 `../../docs/martial-resource-spec.md` |

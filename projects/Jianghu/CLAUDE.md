...
| **2** | 무공·문파·상태이상 체계 | **⚠⚠ 진행 중 (2026-08-01)** — 개별 수치 → **한자 형태소 조합 자동 유도**로 전환 완료. 사전 84자 + 배경어 6자 · 파서 · 조합 규칙 · **무공 138종 작명 완료** · 카탈로그 수치 0줄. **치명 · 상태이상 · 방어군 4축 · 피해 눈금 · 속도 축 · 유형 숙달 재조정 연결 완료.** **✅ 2026-08-01 Unity 확인 통과** — dotnet **159/159** · Unity 컴파일 에러 0 · Unity Test Runner 159/159. 남은 것은 **계층 내 격차**(§4 인계문서). 정의서 `../../docs/martial-resource-spec.md` |

...
| **2** | 무공·문파·상태이상 체계 | **⚠⚠ 진행 중 (2026-07-31)** — 개별 수치 → **한자 형태소 조합 자동 유도**로 전환 완료. 사전 84자 + 배경어 6자 · 파서 · 조합 규칙 · **무공 138종 작명 완료** · 카탈로그 수치 0줄 · **dotnet 153/153**. **치명 · 상태이상 · 방어군 4축 연결 완료(2026-07-31)** — 남은 것은 **피해 스케일 결정 → 속도 축**. 정의서 `../../docs/martial-resource-spec.md` |

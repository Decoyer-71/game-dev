...
namespace Jianghu.Core.Martial.Morphemes
{
    ...
    public static class MorphemeParser
    {
        ...
        ///
        /// ⚠ **미검증 초기값이다.** 기력 50 · 회복 2/턴 기준으로 4자 무공을 3연발(48)하면 고갈되고,
        ///   이후 8턴에 한 번꼴이 된다. 내공 2자(양+음)를 배우면 최대 70 · 회복 6/턴 정도로 완화된다.
        ///   적정한지는 **평타 전락률**(목표 10~30%)로 판정한다(설계안 §5-3).
        ///   기력 고갈 → 평타 전락이 현재 전투의 핵심 드라마이므로, 이 상수가 0에 가까우면 그 드라마가 사라진다.
        /// </summary>
        public const int QiCostPerMorpheme = 4;
